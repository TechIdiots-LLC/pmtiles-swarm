...
| `GET`                  | `/stacks/:id/:size/:z/:x/:y.:ext`                           | The same tile at 256, 512 or 1024 px. A tile's coordinates are an extent rather than a pixel count, so this is the same ground on a finer or coarser grid                                                                                                                                                                                  |
